...
try
{
	...
	rs = statement.executeQuery("SELECT * FROM grsusds.blockedga");
 	while (rs.next()) {
		x++;
	 	r1 = new JSONObject();
       	r1.put("variety", rs.getString("variety"));
       	r1.put("crop", rs.getString("crop"));
       	r1.put("contract", rs.getString("contract"));
       	r1.put("untildate", rs.getString("untildate"));
       	r.add(r1);
	}
	if(x==0)
	{
