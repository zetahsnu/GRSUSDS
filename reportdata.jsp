...
try
{
	...
	while(rs.next()){if(x==0) sb.append("<table id='rtab' size='30%' align='center' style='display:non' class='tablesorter'><thead><tr><th>Sent From</th><th># Varieties Sent</th><th>Year</th></tr></thead><tbody>"); x++; sb.append("<tr><td>" + rs.getString("fromcountry") + "</td><td>" + rs.getString("tot")+ "</td><td>" + yr + "</td></tr>"); }
	}
	...
	while(rs.next()){if(x==0) sb.append("<table id='rtab'  style='display:non' class='tablesorter'><thead><tr><th>Sent From</th><th># Varieties Sent</th><th>Year</th></tr></thead><tbod y>"); x++; sb.append("<tr><td>" + rs.getString("fromcountry") + "</td><td>" + rs.getString("tot")+ "</td><td>" + yr + "</td></tr>"); }
	}
